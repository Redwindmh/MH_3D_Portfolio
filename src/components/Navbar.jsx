  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        <Link to="/MH_3D_Portfolio/" className="flex items-center gap-2" onMouseDown={() => { setActive(""); window.scrollTo(0, 0) }}>
          <img src={logo} alt="HTlogo" className='object-contain w-12 h-12' />
          <p className='text-white text-[18px] font-bold cursor-pointer hover:text-red-600'>Malcolm&nbsp;<span>|&nbsp;Portfolio</span></p>
        </Link>
        ...
        <div className="md:hidden flex flex-1 justify-end items-center">
          <img src={toggle ? close : menu} alt="menu" className='w-[28px] h-[28px] object-contain cursor-pointer' onMouseDown={() => setToggle(!toggle)} />
