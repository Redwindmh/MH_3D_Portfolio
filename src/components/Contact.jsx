        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-black-100 px-6 py-4 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
          ...
          <button
            type="submit"
            className="bg-black-100 px-8 py-3 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl hover:bg-white hover:text-tertiary focus:ring focus:ring-red-500"
          >
